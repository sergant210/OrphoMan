...
$_lang['orphoman_desc'] = 'OrphoMan - управление ошибками на сайте';
$_lang['orphoman_menu_desc'] = 'Управление орфографическими ошибками';
$_lang['orphoman_intro_msg'] = 'Список орфографических ошибок для просмотра и удаления.';

$_lang['orphoman_dialog_title'] = 'Отправить сообщение об ошибке?';
$_lang['orphoman_dialog_mistake'] = 'Ошибка: ';
$_lang['orphoman_dialog_comment'] = 'Комментарий (дополнительно)';
$_lang['orphoman_dialog_comment_title'] = 'Введите комментарий';
$_lang['orphoman_dialog_send'] = 'Отправить';
$_lang['orphoman_dialog_cancel'] = 'Отмена';
