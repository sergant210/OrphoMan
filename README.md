...
Также реализована адаптация для мобильных - диалог сообщения об ошибке в зависимости от разрешения и ориентации телефона меняет размер и положение на странице. И ещё информационная кнопка на мобильных не отображается. Чтобы вернуть её, нужно поправить стиль селектора **#orphography-button**.  
